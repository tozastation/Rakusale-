...
/// BuyVegetableRequest
struct Vegetable_BuyVegetablesRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Vegetable_BuyVegetablesResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Vegetable_BuyVegetablesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".BuyVegetablesRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "token"),
    2: .same(proto: "sID"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.token)
      case 2: try decoder.decodeSingularInt64Field(value: &self.sID)
      case 3: try decoder.decodeSingularEnumField(value: &self.category)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.sID != 0 {
      try visitor.visitSingularInt64Field(value: self.sID, fieldNumber: 2)
    }
    if self.category != .squash {
  ...
  static func ==(lhs: Vegetable_BuyVegetablesRequest, rhs: Vegetable_BuyVegetablesRequest) -> Bool {
    if lhs.token != rhs.token {return false}
...
extension Vegetable_BuyVegetablesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".BuyVegetablesResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "status"),
  ]
  ...
  static func ==(lhs: Vegetable_BuyVegetablesResponse, rhs: Vegetable_BuyVegetablesResponse) -> Bool {
    if lhs.status != rhs.status {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
